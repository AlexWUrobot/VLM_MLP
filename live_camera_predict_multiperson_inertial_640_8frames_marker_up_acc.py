    ...
    try:
        while True:
            ...
            if timing_ms:
                ...
                stage_order = ["grab", "yolo", "clip_enc", "pose_lm", "hand_lm", "phone_probe", "model"]
                total_ms = 0.0
            ...
            if frame_i % 30 == 0:
                total_ms = sum(
                    ...
                    for stage in ["grab", "yolo", "clip_enc", "pose_lm", "hand_lm", "phone_probe", "model", "show"]
                )
                print(
                    ...
                    f"hand={timing_ms.get('hand_lm', 0.0):.0f}ms  probe={timing_ms.get('phone_probe', 0.0):.0f}ms  "
